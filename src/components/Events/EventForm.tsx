...
return;
 ...
 const handleOverlayClick = (e: React.MouseEvent<HTMLDivElement>) => {
   // Проверяем, что клик был именно на overlay (элемент с классом modal-overlay)
 ...
 const handleContentClick = (e: React.MouseEvent<HTMLDivElement>) => {
   // Останавливаем всплытие события, чтобы клик внутри модального окна
   // не доходил до overlay
   e.stopPropagation();
 };
 ...
 return (
   <div className="modal-overlay" onClick={handleOverlayClick}>
     <div className="modal-content large" onClick={handleContentClick}>
